...
FROM            AX_Target.dbo.GENERALJOURNALENTRY GJE 
 ...
 left join FM_OPERATIONS.dbo.AX_OPS_Key AOK on AOK.[AX Trade] = RIGHT(a.LEDGERACCOUNT , CHARINDEX ('-' ,REVERSE(a.LEDGERACCOUNT))-1) 
