...
WHERE        (VTRANS.LASTSETTLEDATE BETWEEN CONVERT(DATETIME, '2016-07-01 00:00:00', 102) AND CONVERT(DATETIME, '2017-6-30 00:00:00', 102)) AND 
                         (VIJ.PURCHID LIKE N'MFAC%') and PV.Vendor_Name not like '%Grainger%' and IDST.Service_Supplies = 'Service' and ABRS.ABR IS NULL
)
...
WHERE        (VTRANS.LASTSETTLEDATE BETWEEN CONVERT(DATETIME, '2016-07-01 00:00:00', 102) AND CONVERT(DATETIME, '2017-6-30 00:00:00', 102)) AND 
                         (VIJ.PURCHID LIKE N'MFAC%') and PV.Vendor_Name not like '%Grainger%' and IDST.Service_Supplies = 'Supplies' and ABRS.ABR IS NULL
)
